...
class CVista {
    /*
    Enum creado para poner la operación que vamos a realizar al buscar
     */
    enum class Operador {
    ...
    fun ingresoDatos() {
         ...
         */
        print("Comencemos la ingresión de datos" + separador() +
     ...
     */
    private fun evaluadorOperador(operador: CVista.Operador): String {
    ...
    fun modificarProducto(): Int? {
        print("¿Qué atributo quiere modificar?" + separador() +
                "(1) Nombre" + separador() +
                "(2) Precio" + separador() +
            "(0) Salir"
        )
